#include "com_kadirnacar_brekbrek_utils_SpeexEncoder.h"
...
JNIEXPORT jint JNICALL Java_com_kadirnacar_brekbrek_utils_SpeexEncoder_allocate
...
JNIEXPORT jint JNICALL Java_com_kadirnacar_brekbrek_utils_SpeexEncoder_deallocate
...
JNIEXPORT jint JNICALL Java_com_kadirnacar_brekbrek_utils_SpeexEncoder_getFrameSize
  (JNIEnv *env, jclass cls, jint slot)
{
    if (throwIfBadSlot(env, slot))
	return -1;
...
JNIEXPORT jbyteArray JNICALL Java_com_kadirnacar_brekbrek_utils_SpeexEncoder_encode
